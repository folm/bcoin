...
dir=$(dirname "$(which "$0")")
url_main='https://raw.githubusercontent.com/folm/fcoin/master/contrib/seeds/nodes_main.txt'
url_testnet='https://raw.githubusercontent.com/folm/fcoin/master/contrib/seeds/nodes_test.txt'
