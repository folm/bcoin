/*!
 * abstractblock.js - abstract block object for fcoin
...
const folmcoinpow = require('../crypto/folmcoinpow');
 ...
 * that Folmcoin reads versions as unsigned despite
...
/**
 * Hash the block headers using vertcoin algorithm.
 * @returns {Hash|Buffer} hash
 */
    AbstractBlock.prototype.powHash = function powHash() {
      var data = this.toHead();
      return folmcoinpow.pow(data, this.time);
    }
