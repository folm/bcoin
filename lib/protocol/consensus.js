/*!
 * consensus.js - consensus constants and helpers for fcoin
...
exports.MAX_MONEY = 22739116 * exports.COIN;
...
exports.BASE_REWARD = 45 * exports.COIN;
...
exports.MAX_RAW_BLOCK_SIZE = 16000000;
...
exports.getReward = function getReward(height, interval) {
  ...
  // https://github.com/folm/bips/blob/master/bip-0042.mediawiki
  if (halvings >= 33)
    return 0;
