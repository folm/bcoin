/*!
 * workerpool.js - worker processes for fcoin
...
function WorkerPool(options) {
  ...
  this.size = getCores();
  this.timeout = 120000;
  this.file = process.env.FCOIN_WORKER_FILE || 'worker.js';
...
Worker.prototype.listen = function listen() {
  ...
  this.sendEnv({
    FCOIN_WORKER_NETWORK: Network.type,
    FCOIN_WORKER_ISTTY: process.stdout
