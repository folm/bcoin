/*!
 * script.js - script interpreter for fcoin
...
/**
 * Convert the script to a folmd test string.
 * @returns {String} Human-readable script code.
 */
...
/**
 * Format the script as folmd asm.
 ...
 * not minimaldata.
 * @see https://lists.linuxfoundation.org/pipermail/folm-dev/2014-November/006878.html
 ...
 * folm itself requires scripthashes to be in strict minimaldata
 ...
 * program (mimics folmd's scriptForWitness).
 * @returns {Script|null}
 */
...
/**
 * Inject properties from folmd test string.
 * @private
